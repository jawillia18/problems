...
def show_results(correct_digits_only, correct_digits_and_position):
    ...
    return(correct_digits_only, correct_digits_and_position)
...
def check_correctness(turns, correct_digits_and_position, correct):
...
def run_game():
    ...
    while not correct and turns < 12:
        #get_answer_input()
        correct_digits_only, correct_digits_and_position =  take_turn(code)
        turns += 1
        correct =  check_correctness(turns, correct_digits_and_position, correct)
